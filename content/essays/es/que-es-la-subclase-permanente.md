---
id: the-permanent-underclass
lang: es
slug: que-es-la-subclase-permanente
title: "¿Qué es la subclase permanente?"
subtitle: "La tesis de que la IA fijará permanentemente la estructura de clases sociales resulta lo bastante alarmante como argumento económico, y lo bastante rentable como argumento de venta."
date: 2026-05-08
...
book: mindkind
translation: the-permanent-underclass
status: published
excerpt: "La subclase permanente es la idea de que, durante los próximos meses o años, la IA cerrará la última ventana histórica en la que el trabajo humano todavía puede producir riqueza generacional. Una tesis lo bastante alarmante como argumento económico, y lo bastante rentable como argumento de venta."
---
...
<figure class="my-10">
<img src="../assets/charts/the-permanent-underclass/productivity-pay-gap.png" alt="Gráfico de líneas del Economic Policy Institute que muestra la productividad neta estadounidense y la remuneración del trabajador típico entre 1948 y 2025. Las dos líneas avanzan juntas hasta 1979 y a partir de ahí se separan: la productividad sigue subiendo y la paga se aplana." class="w-full h-auto rounded-lg">
<figcaption class="text-sm text-c2/60 mt-3 italic font-f2">Productividad neta y remuneración del trabajador típico en EE. UU., 1948 a 2025. Las dos líneas se mueven juntas hasta 1979 y luego se separan. Entre 1979 y 2025, la productividad creció un 90,2% y la paga típica un 33,0%. Fuente: Economic Policy Institute, actualización de marzo de 2026.</figcaption>
</figure>
...
<figure class="my-10">
<img src="../assets/charts/the-permanent-underclass/ai-capability-benchmarks.png" alt="Gráfico de Stanford HAI 2026 AI Index que compara el rendimiento de modelos de IA de frontera con la línea base de expertos humanos en una serie de benchmarks profesionales y de nivel posgrado hasta principios de 2026; las puntuaciones de IA igualan o superan la base humana en varios de ellos." class="w-full h-auto rounded-lg">
<figcaption class="text-sm text-c2/60 mt-3 italic font-f2">Rendimiento de la IA de frontera en una selección de benchmarks profesionales y de nivel posgrado, comparado con la línea base del experto humano, hasta principios de 2026. Fuente: Stanford HAI, AI Index 2026, capítulo Technical Performance.</figcaption>
</figure>
...
<figure class="my-10">
<img src="../assets/charts/the-permanent-underclass/labour-share-gdp.png" alt="Gráfico de líneas de la Reserva Federal de San Luis sobre la participación de la remuneración del trabajo en el PIB estadounidense desde 1947 hasta años recientes: la línea desciende a lo largo del período, con las caídas más marcadas después de 1980." class="w-full h-auto rounded-lg">
<figcaption class="text-sm text-c2/60 mt-3 italic font-f2">Participación de la remuneración del trabajo en el PIB estadounidense, de 1947 a años recientes. La serie cae a lo largo del período, con las bajadas más marcadas a partir de 1980. Fuente: Reserva Federal de San Luis, serie FRED LABSHPUSA156NRUG.</figcaption>
</figure>
...
<figure class="my-10">
<img src="../assets/charts/the-permanent-underclass/wealth-distribution.png" alt="Gráfico de la Reserva Federal con la participación de la riqueza de los hogares estadounidenses por grupo percentil entre 1989 y finales de 2025: las bandas del 1% y del 10% superiores ocupan la mayor parte del área total, y la banda del 50% inferior queda como una franja delgada cerca de la base." class="w-full h-auto rounded-lg">
<figcaption class="text-sm text-c2/60 mt-3 italic font-f2">Participación de la riqueza de los hogares estadounidenses por grupo percentil, de 1989 a finales de 2025. El 10% superior posee en torno al 70% de la riqueza; el 50% inferior, menos del 3%. Fuente: Reserva Federal, Distributional Financial Accounts, cuarto trimestre de 2025.</figcaption>
</figure>
