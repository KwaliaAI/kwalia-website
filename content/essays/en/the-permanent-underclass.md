...
lang: en
slug: the-permanent-underclass
title: "What is the permanent underclass?"
subtitle: "The narrative that AI will freeze the human class structure forever, and why it is both true enough to fear and rigged enough to sell."
date: 2026-05-08
...
<figure class="my-10">
<img src="../assets/charts/the-permanent-underclass/productivity-pay-gap.png" alt="Line chart from the Economic Policy Institute showing US net productivity and typical worker compensation, 1948 to 2025. The two lines move together until 1979, when they begin to diverge sharply, with productivity continuing to rise and pay flattening." class="w-full h-auto rounded-lg">
<figcaption class="text-sm text-c2/60 mt-3 italic font-f2">US net productivity and typical worker compensation, 1948 to 2025. The two lines moved together until 1979, then split. Between 1979 and 2025, productivity grew 90.2% while typical worker pay grew 33.0%. Source: Economic Policy Institute, March 2026 update.</figcaption>
</figure>
...
<figure class="my-10">
<img src="../assets/charts/the-permanent-underclass/ai-capability-benchmarks.png" alt="Chart from Stanford HAI's 2026 AI Index showing frontier AI performance on selected professional and graduate-level benchmarks compared to human-expert baselines through early 2026, with AI scores at or above the human baseline on several benchmarks." class="w-full h-auto rounded-lg">
<figcaption class="text-sm text-c2/60 mt-3 italic font-f2">Frontier AI performance on selected professional and graduate-level benchmarks, with human-expert baseline shown for comparison, through early 2026. Source: Stanford HAI, 2026 AI Index Report, Technical Performance chapter.</figcaption>
</figure>
...
<figure class="my-10">
<img src="../assets/charts/the-permanent-underclass/labour-share-gdp.png" alt="Line chart from the St. Louis Federal Reserve showing the share of labour compensation in US gross domestic product from 1947 to recent years. The line shows the labour share trending downward over the period, with the steepest declines after 1980." class="w-full h-auto rounded-lg">
<figcaption class="text-sm text-c2/60 mt-3 italic font-f2">Share of labour compensation in US GDP, 1947 to recent years. The series falls across the period, most sharply after 1980. Source: St. Louis Federal Reserve, FRED series LABSHPUSA156NRUG.</figcaption>
</figure>
...
<figure class="my-10">
<img src="../assets/charts/the-permanent-underclass/wealth-distribution.png" alt="Federal Reserve chart showing the share of US household wealth held by each percentile group from 1989 through late 2025. The top 1 percent and top 10 percent bands occupy most of the total area; the bottom 50 percent band is a thin strip near the baseline." class="w-full h-auto rounded-lg">
<figcaption class="text-sm text-c2/60 mt-3 italic font-f2">Share of US household wealth by wealth percentile group, 1989 to late 2025. The top 10% holds approximately 70% of wealth; the bottom 50% holds under 3%. Source: Federal Reserve Distributional Financial Accounts, Q4 2025.</figcaption>
</figure>
